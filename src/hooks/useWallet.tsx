...
export const useWallet = () => {
  ...
  const [currentAccount, setCurrentAccount] = useState<string | null>(currentUserAccount);
  ...
  return { walletAddress: useAuthStore((state: { userAccount: any; }) => state.userAccount), connectWallet };
};
